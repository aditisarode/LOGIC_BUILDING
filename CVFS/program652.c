...
//  Description:        It is used to delete a file specific file
//  Input :             FileName
//  Output :            Exit status of function
//  Author:             Aditi Dilip Sarode
//  Date:               02/08/2026
...
//  Description:        It is used to write data into specific file
//  Input :             File Descriptor and Data that you want ot write
//                      and Size of data
               ...
               )
{
    ...
    printf("Data that we want ot write : %s\n", data);
...
//  Description:        It is used to read data from a specific file
//  Input :             File Descriptor and Address of empty buffer
//                      and Size of data
